...
| ------------------------ | -------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `GHVAULT_ENCRYPTION_KEY` | See note | —                       | 32 bytes, base64. AES-256 key for encrypting the GitHub token in SQLite. Required for bare-metal; in Docker, mount via `secrets:` block. Generate once, store securely, never commit. Losing it = re-enter token. |
